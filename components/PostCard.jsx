    ...
    <div className="bg-white shadow-lg rounded-2xl p-0 lg:p-6 lg:pb-6 pb-6 mb-8">
      <div className="relative overflow-hidden shadow-md lg:pb-80 pb-40 mb-6">
        <img
          ...
          alt={post.title}
          className="object-top absolute lg:h-80 h-40 w-full object-cover shadow-lg rounded-t-2xl lg:rounded-2xl"
        />
      </div>
      ...
      hover:text-red-500 lg:text-3xl text-2xl font-semibold px-2"
      >
      ...
      <div className="text-center">
        <Link href={`/post/${post.slug}`}>
          <span className="transition duration-500 transform hover:translate-y-1.5 inline-block bg-red-500 font-normal rounded-full text-white px-6 py-2 cursor-pointer">
            Continue Reading
          </span>
        </Link>
      </div>
